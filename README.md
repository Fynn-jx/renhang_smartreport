...
6. 选择参考文件（本地上传 / 从公文库选择）
7. 实时查看 AI 处理进度（思维链可视化）
8. 编辑生成的 Markdown 内容
9. 导出为 Word 文档
```
...
**功能概述**：
公文库是用户自行上传的、经过人工编译的优质公文模板集合。这些公文是标准化的前沿报告编译成果，作为 AI 写作的风格参考库和知识库。

**核心特性**：
- ✅ **人工精选**：只收录经过人工审核的高质量公文
- 📚 **风格参考**：为 AI 提供标准的公文写作风格参考
- 🎯 **知识积累**：构建组织专属的公文写作知识库
- 🔗 **可被调用**：公文写作工作流可直接引用库中的模板
- 🏷️ **标签管理**：按主题、国家、时间等多维度分类
